...
#ifndef DGE__Core__HashMap_H__
#define DGE__Core__HashMap_H__
...
namespace DGE::Core
{
   ...
   public:
      ...
      void resize(size_type count)
      {
         ...
         chainV = GDCC::Core::Array<ListLink<T>>(count);
   ...
   private:
      GDCC::Core::Array<ListLink<T>> chainV;
      Hash                           hasher;
      KeyEqual                       equal;
