...
namespace Doom
{
   namespace Code
   {
      ...
      //
      Doom_Code_NativeDefn(DGE_FileClose)
      {
         Word fd = argv[0];
      ...
      //
      Doom_Code_NativeDefn(DGE_FileGet)
      {
         Word      fd  = argv[0];
         Word      idx = argv[1];
         FS::File *file;
      ...
      //
      Doom_Code_NativeDefn(DGE_FileOpen)
      {
      ...
      //
      Doom_Code_NativeDefn(DGE_FileRead)
      {
         Word         fd  = argv[0];
         Word         idx = argv[1];
      ...
      //
      Doom_Code_NativeDefn(DGE_FileSize)
      {
         Word      fd = argv[0];
         FS::File *file;
